<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="servisler.aspx.cs" Inherits="servisler" %>
            ...
            <div class="col-md-4 wow fadeInLeft">
                <div class="material_box">
                    <div class="material_box_header dis_color3">
                        <span><i class="fa fa-wrench" aria-hidden="true"></i>&nbsp;SERVİSLER</span>
                    </div>
                </div>
            </div>
            <div class="bg_dis" style="background-image: url('../img/servisler.png');">
                <div class="bosluk"></div>
                <!-- Start Contact -->
                <section id="contact-us" class="contact-us section" style="padding: 0px;">
                    <div class="container">
                        <h4 style="font-family: monospace; font-size: 20px; letter-spacing: 1px; font-weight: 600;">Yetkili servisimiz olmak için aşağıdaki bilgileri doldurunuz.<br/>Bize ulaşın: +90 (539) 406 86 96</h4>
                        <br />
                        <div class="row">
                            <!-- Contact Form -->
